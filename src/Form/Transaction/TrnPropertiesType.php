...
class TrnPropertiesType extends AbstractType
{
    /**
     ...
     */
    public function __construct(MstStateRepository $mstStateRepository, MstCityRepository $mstCityRepository, CommonHelper $commonHelper, Security $security)
    {
